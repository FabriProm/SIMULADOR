# LOGÍSTICA — Rocio Torres

**Pantalla que manejás:** 4 Distribución y almacén
...
|---|---|---|---|---|---|
| Pares disponibles | 2.448 | 2.002 | 1.605 | 1.506 | 7.561 |
| Ventas reales | 2.290 | 1.949 | 1.461 | 1.449 | 7.149 |
| Inventario requerido | 66 | 53 | 43 | 40 | 202 |
| **Excedente** | **92** | **0** | **101** | **17** | **210** |
| **Inventario al cierre** | **158** | **53** | **144** | **57** | **412** |
...
|---|---|---|---|
| Norteamérica | $6,08 | $6,00 | apenas arriba |
| Europa-África | $13,00 | $13,18 | apenas abajo |
| Asia-Pacífico | $6,30 | $6,47 | abajo |
...
|---|---|
| Planta Norteamérica → almacén Norteamérica | 2.377 |
| Planta Norteamérica → almacén Europa-África | 1.242 |
...
| Archivo | Qué mirar |
|---|---|
| **Distribucion y almacen Ano11.pdf** | **Tu reporte principal.** Qué entró, qué se vendió y qué quedó, almacén por almacén |
| **FIR Ano11 - informe de industria completo.pdf** | Página 7: "Costes de distribución y almacenamiento" de las 8 empresas |
| **Resumen de decisiones Ano12.pdf** | Los cinco envíos cargados y la liquidación de inventario |

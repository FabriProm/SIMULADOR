# Punto de restauración — Año 12

**Estado guardado en el simulador antes de la reunión del 19/09.**
Si un cambio de la reunión no da bien, se vuelve a los valores de la columna **AHORA**.

**Está ordenado por el orden en que hay que tomar las decisiones**, no por el número de
pantalla del menú. Cada paso indica a qué pantalla corresponde.

---

## Cómo usarlo

1. **Antes de tocar nada:** anotá los números de referencia de abajo.
2. **Durante la reunión:** cada cambio se anota en el registro del final.
3. **Si algo empeora:** volvé al valor de la columna **AHORA** del paso correspondiente.
4. **Guardá recién cuando el set esté completo.** El botón Guardar graba las diez pantallas
   juntas y reemplaza todo lo anterior: no hay vuelta atrás parcial.
...
| **Rentabilidad sobre el capital** | **24,4%** | 22,0% |
| **Calificación crediticia** | **A** | B+ |
| **Calificación de imagen** | **72** | 72 |
| Ratio de riesgo de impago | 5,09 | más de 4,00 |
| Ingresos netos | $512.246 mil | — |
| Beneficio neto | $60.252 mil | — |
| Caja al cierre | $20.786 mil | — |
| Acciones en circulación | 19.550 mil | — |

> **Ojo con la imagen.** Está clavada en 72, que es exactamente la meta. Cualquier cambio
> que la baje aunque sea un punto hace perder ese objetivo.

---

## El orden de los once pasos

| Paso | Qué se decide | Pantalla del menú | Área |
|---|---|---|---|
| **1** | Supuestos competitivos | al pie de las pantallas 5 y 6 | Analista de Datos |
| **2** | Marketing mayorista | 6 | Marketing |
| **3** | Marketing en internet | 5 | Marketing |
| **4** | Remuneración y formación | 1 | RRHH |
| **5** | Instalaciones de producción | 3 | Mant. y Facility |
| **6** | Producción de marca | 2 | Operaciones |
| **7** | Marca privada | 7 | Operaciones |
| **8** | Distribución y almacén | 4 | Logística |
| **9** | Patrocinios de famosos | 8 | Marketing |
| **10** | Ciudadanía empresarial | 9 | RSE |
| **11** | Finanzas y tesorería | 10 | Finanzas |

Los pasos 2, 6, 7 y 8 son de ida y vuelta: cada cambio de precio hace que el simulador
recalcule cuántos pares hacen falta.

---

# PASO 1 · Supuestos competitivos
**Al pie de las pantallas 5 y 6 · Analista de Datos**

Va primero porque define contra qué nos compara el simulador. Todo lo que sigue depende
de esta vara.

| Campo | ANTES | **AHORA** | Por qué |
|---|---|---|---|
| **Precio mayorista de industria** | 49,63 / 54,63 / 49,63 / 54,63 | **48,63 / 53,63 / 48,63 / 53,63** | Con 12,7% de sobreoferta lo esperable es que la industria baje precios alrededor de un dólar |
| **Precio online de industria** | 69,63 / 75,00 / 69,75 / 75,00 | **68,63 / 74,00 / 68,75 / 74,00** | Ídem |
| **Calidad S/Q de industria** | 4,3 / 4,3 / 4,2 / 4,2 | **4,5 / 4,5 / 4,4 / 4,4** | Con sobreoferta, todos persiguen calidad en vez de bajar precio |
| **Modelos de industria** | 231 en las cuatro | **251 en las cuatro** | Ídem, con la variedad |
| **Publicidad de industria** | 10.563 / 10.000 / 9.063 / 8.250 | **11.063 / 10.500 / 9.563 / 8.750** | +$500: todos empujan un poco más |
| **Buscadores de industria** | 4.906 / 4.281 / 3.906 / 3.844 | **5.406 / 4.781 / 4.406 / 4.344** | Ídem: la pelea se va del precio al gasto en marketing |
| **Rebaja de industria** | $4,80 | **$5,20** | Ídem |
| **Entrega de industria** | 3,0 semanas | **2,8 semanas** | Ídem |
| **Apoyo por local de industria** | 4.281 / 4.281 / 3.063 / 3.156 | **4.481 / 4.481 / 3.263 / 3.356** | Ídem |

> **Este paso solo, sin tocar una sola decisión nuestra, bajó la ganancia por acción
> proyectada de $3,00 a $2,52.** El punto de partida honesto era $2,52.

---

# PASO 2 · Marketing mayorista
**Pantalla 6 · Marketing**

Va antes que internet porque la calidad, los modelos y la publicidad se cargan acá y la
pantalla de internet los hereda.
...
| **Precio Asia-Pacífico** | $49,00 | **$50,50** | Es la región con el mejor margen operativo (24,4%), así que soporta un poco más |
...
| **Rebaja por correo (las cuatro)** | $4,00 | **$5,00** | Estábamos 17% por debajo del promedio ($4,80). El desplegable solo admite dólares enteros, así que $5 es el salto mínimo |
...
| **Apoyo por local Asia-Pac. y Latinoamérica** | $2.750 | **$3.500** | Ídem: cayeron de 700 a 610 y de 700 a 630. El campo va de 250 en 250 |

---

# PASO 3 · Marketing en internet
**Pantalla 5 · Marketing**
...
| Buscadores N.A. y Europa-África | $6.500 / $4.500 | $6.500 / $4.500 | Ya estaban por encima del promedio de la industria |
...
# PASO 4 · Remuneración y formación
**Pantalla 1 · RRHH**
...
# PASO 5 · Instalaciones de producción
**Pantalla 3 · Mantenimiento y Facility**
...
> **Desembolso de capital: $0.** Es la única decisión del set que no tiene una medición que
> la respalde en el largo plazo — seguimos empatados últimos en capacidad de la industria.

---

# PASO 6 · Producción de marca
**Pantalla 2 · Operaciones**

| Campo | ANTES | **AHORA** | Por qué |
|---|---|---|---|
| **Material superior Norteamérica** | 32% | **40%** | Sube la calidad de 4,0 a 4,4 estrellas. En el Año 11 la industria promedió 4,3 y nosotros 4,0: quedamos últimos en pedidos recibidos justamente por esto |
...
| **Estilo por modelo (las dos plantas)** | $10 mil | **$20 mil** | Es lo que cerró la meta de imagen: subió 3 puntos. Cuesta 17 centavos de ganancia por acción. Se probó a $16 mil, $18 mil, $22 mil y $28 mil; $20 mil es el punto óptimo |
...
| **Pares a fabricar Norteamérica** | 3.891 | **4.580** | Absorbe la capacidad que se liberó al achicar la marca privada. Los costos fijos de la planta se reparten entre más pares, así que cada par sale más barato |
...
# PASO 7 · Marca privada
**Pantalla 7 · Operaciones**

Va después de la marca propia porque usa la capacidad que esa deja libre.
...
# PASO 8 · Distribución y almacén
**Pantalla 4 · Logística**

Va al final del bloque de producción porque reparte lo que las dos plantas fabricaron.

| Campo | ANTES | **AHORA** | Por qué |
|---|---|---|---|
| Planta N.A. → almacén Norteamérica | 2.377 | 2.377 | Se probó a 2.600 y se revirtió: no mejoró nada |
...
# PASO 9 · Patrocinios de famosos
**Pantalla 8 · Marketing**
...
# PASO 10 · Ciudadanía empresarial
**Pantalla 9 · RSE**
...
# PASO 11 · Finanzas y tesorería
**Pantalla 10 · Finanzas**

Siempre última: recién acá se sabe cuánta plata generó todo lo anterior.
...
## Cuatro trampas al restaurar

1. **La producción de marca se autolimita.** Para subir los pares de marca propia hay que
   **bajar primero la marca privada, guardar, y después subir**. Al revés, el campo vuelve
   solo a su valor anterior sin avisar.
2. **Las casillas de "incorporar en proyecciones"** de marca privada se resetean a "No"
   cuando un envío pasa por cero. Revisá las cuatro después de cada cambio en esa pantalla.
3. **Algunos campos no disparan el recálculo** aunque muestren el valor nuevo. Si un cambio
   no mueve ningún número del panel, reescribí el campo y salí con tabulador.
4. **Navegar entre pantallas descarta lo no guardado.** Guardá antes de cambiar de pantalla.

---

## Registro de cambios de la reunión

| # | Paso | Campo | Valor anterior | Valor nuevo | BPA | ROE | Crédito | Imagen | ¿Queda? |
|---|---|---|---|---|---|---|---|---|---|
| — | — | *(punto de partida)* | — | — | **$3,08** | **24,4%** | **A** | **72** | — |
| 1 | | | | | | | | | |
| 2 | | | | | | | | | |
| 3 | | | | | | | | | |
| 4 | | | | | | | | | |
...
## Antes de guardar el set final

- [ ] Excedente cerca de cero en las cuatro regiones (paso 8)
- [ ] Las dos plantas al tope: 4.800 pares brutos cada una (pasos 6 y 7)
- [ ] Las cuatro casillas de "incorporar en proyecciones" en Sí (paso 7)
- [ ] Precio de internet al menos 40% por encima del mayorista (paso 3)
- [ ] Ratio de riesgo de impago por encima de 4,00 (paso 11)
- [ ] Los cuatro indicadores iguales o mejores que el punto de partida
- [ ] Botón **Guardar decisiones** apretado y confirmado recargando la página

---

*Registrado el 18/09/2026 a partir del set cargado en el simulador.
La fuente de verdad es el "Resumen de decisión" que imprime el propio sistema.*
